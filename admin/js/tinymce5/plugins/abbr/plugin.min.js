tinymce.PluginManager.add('abbr', function(editor,url) {
	...
	editor.addCommand('tinymce_abbr_modal', function() {
		...
		if (text.length === 0 ) {
			alert('Bitte zunächst einen Begriff auswählen!');
			return;
		}
		...
		if (node.nodeName == 'ABBR') {
			...
			editor.windowManager.open({
        		...
        		type   : 'textbox',
			   		...
			   		name   : 'abbrTitle',
			   		label  : 'Bedeutung',
			   		tooltip: 'Die Bedeutung Ihrer Abkürzung',
         },
		   		{
        		type   : 'textbox',
			   		...
			   		name   : 'abbrLang',
			   		label  : 'Sprache',
			   		tooltip: 'Die Sprache in der die Bedeutung verfasst wurde (DE, EN, ...)',
        	},
		   	],
		   	onsubmit: function(e) {
				  var text = editor.selection.getContent({
